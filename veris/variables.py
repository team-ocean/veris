...
VARIABLES = dict(
    ...
    IcePenetSW      = Variable("Shortwave radiation that penetrates through the ice", grid, "W/m2"),
    # ocean
    ...
    evap            = Variable("Evaporation rate over open ocean (freshwater flux, <0 increases salinity)", grid, "m/s"),
