...
SETTINGS = dict(
    ...
    secondOrderBC       = Setting(False, bool, "flag for using the second order approximation for boundary conditions"),
    ...
    use_coastline       = Setting(False, bool, "flag for using the coastline data for lateral drag"),
    ...
    dtempFrz_dS         = Setting(0, float, "derivative of freezing temperature wrt salinity [°C/(g/kg)]"), # - 0.0575
