...
To use Veris as a standalone model, see the scripts provided [here](https://github.com/jpgaertner/veris_minimum_working_example) ![DOI](https://zenodo.org/badge/953970891.svg).
